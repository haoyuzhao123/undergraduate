...
//add DO OD
LESS_EQUAL   GREATER_EQUAL  EQUAL   NOT_EQUAL VERTS
//add COMPLEX case default
'+'  '-'  '*'  '/'  '%'  '='  '>'  '<'  '.' '@' '$' '#' ':'
','  ';'  '!'  '('  ')'  '['  ']'  '{'  '}'
//add case, default
CASE DEFAULT
...
Oper8           :   '@'
                ...
                |   '#'
                    {
                        $$.counter = Tree.TOCOMPLEX;
                        $$.loc = $1.loc;
                    }
                    //end the Oper for COMPLEX
                ;
...
DoSubStmt       :   Expr ':' Stmt
                    ...
                    ;
DoBranchList    :	VERTS DoSubStmt DoBranchList
					{
						$$.slist.add($2.stmt);
