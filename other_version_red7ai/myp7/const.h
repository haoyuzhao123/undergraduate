...
const int N=7,Nc=10,M=78,T=1000000, T2=1000,S=128,M1=127,Sd1=3412439;
const double Eps=1e-9,  _C[N+1]={0,2,2,2,2,2,1,0.7};

double C;

int S2[1<<N], S3[1<<N], Fc[M+1], Sc2[1<<N], MCS1, MCS2;
const int RT[N+1][2]={{0,0},{10000,10},{10000,10},{1000,10},{70,20},{15,20},{4,20},{1,20}};
